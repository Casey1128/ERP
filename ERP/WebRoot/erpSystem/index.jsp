...
<body class="easyui-layout">
   <div data-options="region:'north',title:'进销存管理',split:true" style="height:100px;">
        <img id="logo" src="/ERP/erpSystem/images/logo.png"  />
   </div>
   <div data-options="region:'west',title:'导航',split:true" style="width:200px;">
     <div id="aa" class="easyui-accordion" fit="true">
       <div title="基础信息管理" data-options="iconCls:'icon-save',selected:true">
          <ul>
             <li><a href="#" onclick="addTab('公司信息','/ERP/SearchBaseCompanyServlet')">公司信息</a></li>
             <li><a href="#" onclick="addTab('字典信息','/ERP/SearchBaseContentServlet')">字典信息</a></li>
             <li><a href="#" onclick="addTab('往来单位管理','/ERP/Unit/unitIndex.jsp')">往来单位管理</a></li>
              <li><a href="#" onclick="addTab('配件信息','/ERP/console/baseparts/basepartsList.jsp')">配件信息</a></li>
              <li><a href="#" onclick="addTab('配件类别信息','/ERP/erpSystem/PageBean.jsp')">配件类别信息</a></li>
          </ul>
       </div>
       ...
       <ul>
           ...
           <li><a href="#" onclick="addTab('询价单管理','/ERP/purchase/SearchPurchaseInqueryServlet')">询价单管理</a></li>
           ...
           <li><a href="#" onclick="addTab('采购退货管理','/ERP/purchase/SearchPurchaseReturnServlet')">采购退货管理</a></li>
       </ul>
       </div>
