...
public class getCategoryTypeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public getCategoryTypeServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<BasePartsCategory> parts=partsCategory.getCategoryList();
		
		JSONArray array=JSONArray.fromObject(parts);
		String jsonPartList=array.toString();
		response.getWriter().println(jsonPartList);
	}
